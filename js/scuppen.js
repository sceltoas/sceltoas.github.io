...
var participants = [
    {name: 'Ole Tommy', results: [PARTICIPATED, 6, PARTICIPATED, PARTICIPATED]},
    {name: 'Ivar', results: [PARTICIPATED, NOT_PARTICIPATED, NOT_PARTICIPATED, NOT_PARTICIPATED]},
    {name: 'Jan Erik', results: [PARTICIPATED, 7, PARTICIPATED, NOT_PARTICIPATED]},
    {name: 'Herman', results: [PARTICIPATED, 6, PARTICIPATED, 3]},
    {name: 'Ole-André', results: [4, 6, PARTICIPATED, PARTICIPATED]},
    {name: 'Tor Eric', results: [PARTICIPATED, 6, PARTICIPATED, 1]},
    {name: 'Håken', results: [PARTICIPATED, 4, PARTICIPATED, PARTICIPATED]},
    {name: 'Gustav', results: [NOT_PARTICIPATED, 2, PARTICIPATED, PARTICIPATED]},
    {name: 'Erlend', results: [1, 7, 1, PARTICIPATED]},
    {name: 'Marius', results: [PARTICIPATED, 7, PARTICIPATED, 2]},
    {name: 'Erik', results: [NOT_PARTICIPATED, 3, PARTICIPATED, 4]},
    {name: 'Richard', results: [PARTICIPATED, 3, 1, PARTICIPATED]},
    {name: 'Lars Fredrik', results: [NOT_PARTICIPATED, 6, PARTICIPATED, PARTICIPATED]},
    {name: 'Fredrik B', results: [PARTICIPATED, 4, 1, NOT_PARTICIPATED]},
    {name: 'Fredrik S', results: [PARTICIPATED, 4, PARTICIPATED, PARTICIPATED]},
    {name: 'Bjarte', results: [PARTICIPATED, 7, PARTICIPATED, PARTICIPATED]},
    {name: 'Vetle', results: [PARTICIPATED, 1, PARTICIPATED, PARTICIPATED]},
    {name: 'Ken', results: [3, 5, 1, PARTICIPATED]},
    {name: 'Sean', results: [2, NOT_PARTICIPATED, NOT_PARTICIPATED, PARTICIPATED]}
];
