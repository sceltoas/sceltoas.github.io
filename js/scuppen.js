...
var participants = [
    {name: 'Ole Tommy', results: [PARTICIPATED, 6, PARTICIPATED]},
    {name: 'Ivar', results: [PARTICIPATED, NOT_PARTICIPATED, NOT_PARTICIPATED]},
    {name: 'Jan Erik', results: [PARTICIPATED, 7, PARTICIPATED]},
    {name: 'Herman', results: [PARTICIPATED, 6, PARTICIPATED]},
    {name: 'Ole-André', results: [4, 6, PARTICIPATED]},
    {name: 'Tor Eric', results: [PARTICIPATED, 6, PARTICIPATED]},
    {name: 'Håken', results: [PARTICIPATED, 4, PARTICIPATED]},
    {name: 'Gustav', results: [NOT_PARTICIPATED, 2, PARTICIPATED]},
    {name: 'Erlend', results: [1, 7, 1]},
    {name: 'Marius', results: [PARTICIPATED, 7, PARTICIPATED]},
    {name: 'Erik', results: [NOT_PARTICIPATED, 3, PARTICIPATED]},
    {name: 'Richard', results: [PARTICIPATED, 3, 1]},
    {name: 'Lars Fredrik', results: [NOT_PARTICIPATED, 6, PARTICIPATED]},
    {name: 'Fredrik B', results: [PARTICIPATED, 4, 1]},
    {name: 'Fredrik S', results: [PARTICIPATED, 4, PARTICIPATED]},
    {name: 'Bjarte', results: [PARTICIPATED, 7, PARTICIPATED]},
    {name: 'Vetle', results: [PARTICIPATED, 1, PARTICIPATED]},
    {name: 'Ken', results: [3, 5, 1]},
    {name: 'Sean', results: [2, NOT_PARTICIPATED, NOT_PARTICIPATED]}
];
